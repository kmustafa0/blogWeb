                        ...
                        <div class="container px-10 px-lg-10">
                            <div class="row gx-4 gx-xl-5 justify-content-center">
                                <div class="col-md-15 col-lg-8 col-xl-7">
                                    <center>
                                        <form method="POST">
                                            <h4 class="mt-5">İçerik Düzenle</h4>
                                            <br />
                                            <!-- Title input -->
                                            ...
                                            <!-- Content input -->
                                            <div class="form-outline mb-6">
                                                <textarea class="form-control" id="form4Example3" placeholder="İçerik" name="content" rows="10"><?php
                                            ...
                                            <button type="submit" name="goPosts" class="btn btn-danger btn-block mb-4">Geri
                                                Dön</button>
                                        </form>
                                    </center><br />
                                </div>
