...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="posts.php">Mustafa.Blog</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="../index.php">Siteyi Gör</a>
                    </li>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="site-heading">
                        <h4>Giriş yapan: <span><?php if (array_key_exists('user', $_SESSION)) {
                                                        echo ($_SESSION['user']);
                                                    } ?></span></h4>
                    </div>
                </div>
            ...
            <div class="col-md-15 col-lg-8 col-xl-7">
                <center>
                    <form method="POST">
                        ...
                        <!-- Content input -->
                        <div class="form-outline mb-6">
                            <textarea class="form-control" id="form4Example3" placeholder="İçerik" name="content"
                                rows="20"><?php
                        ...
                        <?php
                            ...
                            if (isset($_POST["sendPost"])) {
                                ...
                                if ($title != "" && $content != "") {
                                    $ekle = mysqli_query($conn, "INSERT INTO posts (post_title, post_content) VALUES ('" . mysqli_real_escape_string($conn, $title) . "','" . mysqli_real_escape_string($conn, $content) . "')");
